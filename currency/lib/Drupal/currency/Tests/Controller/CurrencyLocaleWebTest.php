...
class CurrencyLocaleWebTest extends WebTestBase {
  ...
  function testListing() {
    ...
    $this->drupalGet('admin/config/regional/currency_locale');
    $this->assertText('Dutch (Netherlands)');
    $this->assertLinkByHref('admin/config/regional/currency_locale/nl_NL');
    $this->assertLinkByHref('admin/config/regional/currency_locale/nl_NL/delete');
    ...
    // currency locale.
    $this->assertLinkByHref('admin/config/regional/currency_locale/' . $locale_delegator::DEFAULT_LOCALE);
    $this->assertNoLinkByHref('admin/config/regional/currency_locale/' . $locale_delegator::DEFAULT_LOCALE . '/delete');
  }
}
